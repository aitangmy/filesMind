...
def generate_random_markdown(filename, num_sections=5, max_depth=4, sentences_per_section=3):
    ...
    words = ["Lorem", "ipsum", "dolor", "sit", "amet", "consectetur", "adipiscing", "elit", 
             ...
             "magna", "aliqua", "Hierarchy", "Structure", "Parsing", "Cognitive", "Engine", 
             "DeepSeek", "Analysis", "Data", "Model", "Test", "Verification"]
    ...
    for _ in range(num_sections * 3): # Generate enough content
        ...
        if current_depth == 1: section_title = "Root (Should not happen in body)" # Guard
